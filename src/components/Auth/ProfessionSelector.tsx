    ...
    <div className="space-y-3 sm:space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition text-sm sm:text-base"
        />
      </div>
      ...
      <div className="max-h-48 sm:max-h-60 overflow-y-auto space-y-2">
        {filteredProfessions.map((profession) => (
          ...
          >
            <span className="font-medium text-sm sm:text-base">{profession}</span>
          </button>
        ))}
      </div>
